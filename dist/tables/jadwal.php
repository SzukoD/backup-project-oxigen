      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Data Jadwal</h3></div>
              <div class="col-sm-6">
        ...
        <div class="table-responsive">
          <table id="tabelPelatih" class="table table-striped table-bordered nowrap" style="width:100%">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>Yoga</td>
                <td>082145678912</td>
                <td>Selasa - Kamis (15.00 - 19.00)</td>
                <td><span class="badge text-bg-success">Aktif</span></td>
              </tr>
              <tr>
                <td>TR003</td>
                ...
                <td>Body Building</td>
                <td>081398745621</td>
                <td>Senin - Sabtu (10.00 - 17.00)</td>
                <td><span class="badge text-bg-danger">Tidak Aktif</span></td>
              </tr>
              <tr>
                <td>TR004</td>
                <td>Melati Lestari</td>
                <td>Zumba</td>
                <td>085789456123</td>
                <td>Rabu & Jumat (16.00 - 18.00)</td>
                <td><span class="badge text-bg-success">Aktif</span></td>
              </tr>
              <tr>
                <td>TR005</td>
