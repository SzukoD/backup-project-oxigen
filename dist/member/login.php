...
<head>
  ...
  <style>
    ...
    .login-container {
      background: rgba(60, 20, 20, 0.9); /* card sedikit lebih terang dari background */
      border-radius: 22px;
...
<body>
  <div class="login-container">
    <h2>Welcome to <span style="color:#ff4b4b;">FitForge</span></h2>
    <p>Login untuk melanjutkan perjalanan kebugaranmu 💪</p>
